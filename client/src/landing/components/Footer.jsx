        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-base font-bold text-text-primary">API Guard</span>
            </div>
            <p className="text-sm text-text-secondary leading-relaxed mb-4">
              Lightweight API monitoring and analytics for modern teams.
            </p>
            <div className="flex gap-3">
              ...
              <a
                ...
                className="w-9 h-9 rounded-lg bg-surface-card border border-border
              ...
              <a
                ...
                aria-label="Twitter"
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-text-secondary">
